# Continuous Integration ![https://github.com/x-ndy/continuous-integration/actions?query=workflow%3Atests](https://github.com/x-ndy/continuous-integration/workflows/tests/badge.svg)
